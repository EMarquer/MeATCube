...
numeric_columns = "Pregnancies,Glucose,BloodPressure,SkinThickness,Insulin,BMI,DiabetesPedigreeFunction,Age".split(",")
symbolic_columns = set(columns).difference(numeric_columns + [target_column])

if __name__ == "__main__":
    # multiple .data files
    data_file_name = utils.auto_data_path_from_preprocess_file(__file__, extension=".csv")[0]
